...
// ⚡ Bolt: Using a regex .exec() loop avoids the function execution context overhead and intermediate array allocations created by .split().filter().
// Impact: Reduces GC pressure and improves execution speed during search tokenization, especially for large documents evaluated in loops.
