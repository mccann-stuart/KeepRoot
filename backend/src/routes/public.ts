import { appendSecurityHeaders, corsHeaders, securityHeaders, errorResponse, isProtectedApiPath, type RouteContext } from '../http';
...
async function handleStoredObjectRequest(context: RouteContext): Promise<Response> {
	...
	const headers = appendSecurityHeaders(new Headers());
