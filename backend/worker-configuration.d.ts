/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: acc6c010136e255dd88397cfc0c4f639)
...
interface __BaseEnv_Env {
	...
	SOURCE_QUEUE: Queue;
	SOURCE_DLQ: Queue;
	BROWSER_RUN_API_TOKEN: SecretsStoreSecret;
	AUTH_RATE_LIMITER: RateLimit;
	WRITE_RATE_LIMITER: RateLimit;
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	ALLOWED_EXTENSION_IDS: "[\"jgdahkljlabhpmeifmnnibejdkcbhphf\"]";
	ALLOW_REGISTRATION: "1";
	AUTH_ORIGIN: "https://keeproot.booms-17-brooms.workers.dev";
	BROWSER_RUN_ACCOUNT_ID: "2e3895c5eec3a37afbe1e4df68e4be28";
	BROWSER_CRAWL_WORKFLOW: Workflow<Parameters<import("./src/index").BrowserSourceCrawlWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_EXTENSION_IDS" | "ALLOW_REGISTRATION" | "AUTH_ORIGIN" | "BROWSER_RUN_ACCOUNT_ID">> {}
}
