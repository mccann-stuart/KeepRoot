...
- Fixed username-based passkey login when several KeepRoot accounts have credentials for the same Worker origin, prevented concurrent passkey actions from interrupting one another, and made authentication failures visible inside the login dialog.
